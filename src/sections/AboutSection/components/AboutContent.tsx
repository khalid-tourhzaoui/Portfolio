  ...
  return (
    <div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 py-12 sm:py-16 md:py-20 lg:py-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 md:gap-8">
        {/* Left Column - Mission & Core Abilities */}
        <div className="lg:col-span-7 space-y-4 sm:space-y-6">
          ...
          <div className="bg-emerald-700/40 backdrop-blur-sm border-3 sm:border-4 border-emerald-600/50 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-[rgba(0,0,0,0.3)_0px_6px_0px_0px] sm:shadow-[rgba(0,0,0,0.3)_0px_8px_0px_0px]">
            <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6 pb-3 sm:pb-4 border-b-2 border-white/20">
              ...
              <div>
                <h3 className="text-white text-xl sm:text-2xl md:text-3xl font-black uppercase">MISSION</h3>
              </div>
            </div>

            <p className="text-white/90 text-xs sm:text-sm md:text-base leading-relaxed mb-4 sm:mb-6">
              I create efficient, user-friendly web applications from concept to deployment. 
              My approach combines modern frameworks with best practices to deliver reliable solutions. 
              Whether it's building management systems or interactive platforms, I focus on performance, 
          ...
          <div className="bg-emerald-700/40 backdrop-blur-sm border-3 sm:border-4 border-emerald-600/50 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-[rgba(0,0,0,0.3)_0px_6px_0px_0px] sm:shadow-[rgba(0,0,0,0.3)_0px_8px_0px_0px]">
            <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6 pb-3 sm:pb-4 border-b-2 border-white/20">
              ...
              <div>
                <h3 className="text-white text-xl sm:text-2xl md:text-3xl font-black uppercase">CORE ABILITIES</h3>
                <p className="text-white/70 text-[10px] sm:text-xs md:text-sm font-bold">Mastered Skills</p>
              </div>
            </div>
                  ...
                  >
                    <div className="flex items-center gap-2 sm:gap-3">
                      ...
                      <div className="min-w-0">
                        <h4 className="text-white font-black text-xs sm:text-sm md:text-base truncate">{ability.name}</h4>
                        <p className="text-emerald-300 text-[10px] sm:text-xs font-bold">{ability.level}</p>
                      </div>
                    </div>
                  </div>
                );
        ...
        <div className="lg:col-span-5">
          <div className="bg-gradient-to-br from-zinc-700 to-zinc-800 border-3 sm:border-4 border-zinc-800 rounded-xl sm:rounded-2xl overflow-hidden shadow-[rgba(0,0,0,0.9)_0px_8px_0px_0px] sm:shadow-[rgba(0,0,0,0.9)_0px_12px_0px_0px]">
            ...
            <div className="relative bg-zinc-600/50">
              <img
                src="https://gauravbitsgamingportfolio.netlify.app/assets/about-C0vwj3CE.JPG"
            ...
            <div className="bg-emerald-600 border-t-3 sm:border-t-4 border-zinc-900 p-3 sm:p-4 text-center">
              <div className="flex items-center justify-center gap-2 mb-1">
                ...
                <span className="text-white text-xs sm:text-sm font-black uppercase">AVAILABLE FOR WORK</span>
              </div>
              <span className="text-emerald-100 text-[10px] sm:text-xs font-bold">Open to new opportunities and projects</span>
            </div>
          </div>
        </div>
      </div>
